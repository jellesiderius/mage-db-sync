...
class ChecksTask extends mainTasks_1.default {
    constructor() {
        super(...arguments);
        this.tasks = [];
        ...
        this.configure = (list) => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=checksTask%20copy.js.map